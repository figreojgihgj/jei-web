...
### 最新更新
- **增强 CenterPanel 组件** - 添加 `save-plan` 事件和 `loadAdvancedPlan` 方法
- **高级计划器增强** - 新增节点图视图和计算器视图功能
- **组件重构** - 新增 ItemContextMenu、ItemDialog、ItemListPanel、RecipeContentView、SettingsDialog 等组件
- **导航栈调试** - 添加导航栈调试面板功能，可拖动悬浮窗显示导航状态
- **Vue Flow 优化** - 改进深色主题样式，修复拖拽功能和连线层级问题
- **上下文菜单修复** - 修复上下文菜单关闭后目标未清除的问题
- **界面优化** - 优化流程图中输入输出端口样式和代码格式
